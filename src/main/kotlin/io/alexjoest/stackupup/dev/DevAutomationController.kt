 ...
 */
class DevAutomationController(
    private val confirmationRetryTicks: Int = 40
) {
    ...
    fun advance(snapshot: DevAutomationSnapshot): List<DevAutomationAction> {
        return when (state) {
            ...
            DevAutomationState.ABORTED -> emptyList()
        }
    }
